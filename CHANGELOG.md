...
- **Plugin\AdminDashboardTrait**: Fixed inline control structure, broke long heredoc lines to comply with 120-char limit
- **REST\RateLimiter**: Fixed inline control structure for `ABSPATH` guard
